...
//     new THREE.MeshBasicMaterial({ map: noises.renderTarget.texture })
// )
...
disc.material.uniforms.uTime = { value: 0 }
disc.material.uniforms.uGradientTexture = { value: disc.gradient.texture }
disc.material.uniforms.uNoisesTexture = { value: noises.renderTarget.texture }
...
composition.plane.material.uniforms.uTime = { value: 0 }
composition.plane.material.uniforms.uDefaultTexture = { value: composition.defaultRenderTarget.texture }
composition.plane.material.uniforms.uDistortionTexture = { value: composition.distortionRenderTarget.texture }
composition.plane.material.uniforms.uConvergencePosition = { value: new THREE.Vector2() }
